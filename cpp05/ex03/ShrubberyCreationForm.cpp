...
/*   Updated: 2025/03/15 17:51:46 by tao              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ShrubberyCreationForm::ShrubberyCreationForm() :
	_target("mystery"), AForm ("Shrubbery Form", 145, 137){
	return ;
}

ShrubberyCreationForm::ShrubberyCreationForm(std::string target) :
	_target(target), AForm ("Shrubbery Form", 145, 137) {
	return ;
}

ShrubberyCreationForm::ShrubberyCreationForm(ShrubberyCreationForm const &copie) :
	_target(copie._target), AForm ("Shrubbery Form", 145, 137) {
	return ;
}
