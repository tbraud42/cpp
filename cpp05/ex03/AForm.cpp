...
/*   Updated: 2025/03/15 17:50:46 by tao              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm() :
	_name("tax Form"), _signed(false), _gradeForSign(150), _gradeForExecute(150) {
	return ;
}

AForm::AForm(std::string name, unsigned int gradeForSign, unsigned int gradeForExecute) :
...
AForm::AForm(AForm const &copie) :
	_name(copie._name), _signed(copie._signed), _gradeForSign(copie._gradeForSign), _gradeForExecute(copie._gradeForExecute) {
	return ;
}
